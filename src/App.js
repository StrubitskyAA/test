...
const App = () => {
  ...
  const handleFormSubmit = () => {
    ...
    delete clonedInputValues.buyersPromptDateFrom;
    delete clonedInputValues.buyersPromptDateTo;
    if (data.buyersPromptDate) {
      clonedInputValues.buyersPromptDate = data.buyersPromptDate;
    }
    console.log("clonedInputValues = ", clonedInputValues);
    ...
    // console.log(clonedInputValues, data, selectedOptions);
          ...
          <div key={columnDetail.columnId}>
            ...
            columnDetail.tblReportControlMaster[0].controlType === "combo" ? (
              ...
              <>
                ...
                >
                  <option value="">Select undefined</option>
                ...
                <input
                  ...
                  value={
                    inputValues[columnDetail.selectFieldName + "From"] || ""
                  }
                  onChange={(e) =>
                ...
                {dateType === "between" ? (
                  <input
                    ...
                    value={
                      inputValues[columnDetail.selectFieldName + "To"] || ""
                    }
                    onChange={(e) =>
